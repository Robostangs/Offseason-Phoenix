...
public class SetFeederPowerCommand extends CommandBase {
    ...
    public SetFeederPowerCommand(FeederSubsystem feederSubsystem, DoubleSupplier shooterPowerSupplier) {
